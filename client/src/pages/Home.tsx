...
import "@/styles/galleryOrganization.css";
import "@/styles/galleryExport.css";
import "@/styles/canvasFirstPass.css";
...
export default function Home() {
  ...
  const handleSave = () => { const artwork = saveArtwork(captureStudioImage(objects, 520, 340) ?? undefined); if (!artwork) { toast.error("Add a shape before saving your artwork."); return; } setIsCelebrating(true); playStudioSound("celebrate", soundEnabled, soundVolume); toast.success(`Saved “${artwork.title}” to this device.`); };
