...
import { Archive, CircleHelp, Download, Eraser, GalleryHorizontalEnd, Layers3, Redo2, Sparkles, Undo2 } from "lucide-react";
...
export default function Home() {
  ...
  const handleSave = () => { const artwork = saveArtwork(captureStudioImage(objects, 520, 340) ?? undefined); if (!artwork) { toast.error("Add a shape before saving your artwork."); return; } toast.success(`Saved “${artwork.title}” to this device.`); };
